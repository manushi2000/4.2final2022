   ...
   // include_once 'mpesa.php';
    ...
    class Menu{
        ...
        function back_calculations($date,$days){
            ...
            return [$next_period,$firstday,$lastday];
        }
        ...
        public function mainMenuRegistered($name){
            ...
            $response .= "3: Donation for sanitary pads\n";
            echo $response;
        }
        ...
        public function periodAndCycle($textArray){
            ...
            if($level == 1){
                $date= "CON Please enter the first day of your last menstrual period:\n";
                echo $date."\n";
                // $inputDate=
                // echo $textArray[1];
            } 
            else if($level==2){
                echo "CON Enter your usual number of days in your cycle:\n";
            }
            else if($level==3){

                $result = $this->back_calculations($textArray[1],(int)$textArray[2]);// MM/DD/YYYY
                
                echo  "END Your Next period will start on: ".(string)$result[0]."\n First fertile day:".(string)$result[1]."\n Last fertile day:".(string)$result[2];
                savetracker((string)$result[0],(string)$result[1],(string)$result[2]);
                // echo "END Date".$textArray[1]."--->".$textArray[2];
            }
            // if($level == 1){
            //  echo "12/12/2022";
            // //  $GetDate = ....;
            // }
            //   else if ($level == 2) {
            // $ndays= "CON Enter your usual number of days in your cycle:\n";
            // // echo $ndays;
            // }
