...
function savetracker($nextperioddate,$startfertiledate,$endfertiledate){
$conn = opencon();
  


        $sql = "INSERT INTO periodtracker (`NextDate`, `StartFertileDate`, `EndFertileDate`) VALUES ('$nextperioddate','$startfertiledate','$endfertiledate')";
